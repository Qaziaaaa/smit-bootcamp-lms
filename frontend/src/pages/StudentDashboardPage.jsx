...
export default function StudentDashboardPage() {
  ...
  return (
    <div className="grid gap-3">
      ...
      <div className="flex flex-col gap-2 rounded-xl bg-[linear-gradient(135deg,#61bb46 0%,#61bb46 15%,hsl(var(--clr-blue-dark)) 65%)] p-3 text-white shadow-md md:flex-row md:items-center md:justify-between">
