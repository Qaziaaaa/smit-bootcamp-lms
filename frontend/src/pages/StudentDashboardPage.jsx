...
export default function StudentDashboardPage() {
  ...
  return (
    <div className="grid gap-3">
      ...
      <div style={{ background: 'linear-gradient(135deg, #61bb46 0%, #61bb46 20%, #0873b9 35%)' }} className="flex flex-col gap-2 rounded-xl p-3 text-white shadow-md md:flex-row md:items-center md:justify-between">
