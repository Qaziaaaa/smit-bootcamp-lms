...
| Layer | Technology |
|---|---|
| Frontend | React 18 (CRA), MUI, Lucide React, React Router, Axios, React Hook Form + Zod, Redux Toolkit, TanStack Query, TanStack Table, Recharts, Sonner, Framer Motion, Day.js, React Dropzone, Fuse.js |
